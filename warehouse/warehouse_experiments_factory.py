...
class WarehouseExperimentsFactory(ExperimentsFactory):
    ...
    def build_experiment(self) -> Experiment:
        ...
        for pair in agent_search.pairs:
            if matrix[pair.cell1.line][pair.cell1.column] == constants.PRODUCT:
            ...
            if matrix[pair.cell2.line][pair.cell2.column] == constants.PRODUCT:
                if matrix[pair.cell2.line][pair.cell2.column - 1] == constants.EMPTY:
            ...
            sol = agent_search.solve_problem(problem)
    ...
    def build_experiment_textual_representation(self) -> str:
        ...
        string += 'Problem file: ' + self.get_parameter_value('Problem_file') + '\r\n'
        return string
    ...
    def build_experiment_values(self) -> str:
        ...
        string += self.get_parameter_value('Problem_file') + '\t'
        return string
